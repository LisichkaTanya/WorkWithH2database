...
public class AddressService extends Util implements GenericDAO<Address, Long> {
    ...
    public void add(Address address) throws SQLException {
        //Если запрос выполняется часто и особенно с большим количеством условий, то лучше использовать
        // PreparedStatement, в таком случае производится прекомпиляция и оптимизация запроса один раз,
    ...
    public List<Address> getAll() throws SQLException {
        ...
        //Если запрос используется не часто или простой, то можно использовать обычный стейтмент,
        // чтобы не забивать пул прекомпилированных стейтментов
